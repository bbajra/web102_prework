  ...
  for (let i = 0; i < games.length; i++) {
    ...
    gameCard.innerHTML = `
      ...
      <div class="game-info">
        ...
        <!-- Add additional game attributes here -->
      </div>
    `;
...
raisedCard.innerHTML = `Total Pledges: $${totalPledges}`;
...
const displayStr = `A total of <strong>$${totalRaised.toLocaleString(
  "en-US"
)}</strong> has been raised for <strong>${
  GAMES_JSON.length
}</strong> games. Currently, <strong>${numUnfunded}</strong> ${
